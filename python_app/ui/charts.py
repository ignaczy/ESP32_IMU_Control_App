...
def draw_chart(surface, rect, font, charts_config):
    """
    Rysuje jeden lub wiele wykresów w wskazanym obszarze 'rect'.
    """
    ...
    for idx, cfg in enumerate(charts_config):
        ...
        left_margin = 45
        top_margin = 20
        bottom_margin = 22  # Zabezpiecza etykiety osi Y (np. -30.0)
